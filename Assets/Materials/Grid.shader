...
Shader "Grid"
{
	Properties
	{
		...
		_TopThreshold("Top Threshold", Float) = 0
		[Toggle(_HASGRID_ON)] _HasGrid("HasGrid", Float) = 1
		_Tiling("Tiling", Float) = 0.5
		_TexOffset("TexOffset", Vector) = (0.5,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _HASGRID_ON
						...
						)
			{
				...
				float4 triplanar12 = TriplanarSampling12( _Texture0, ( ase_worldPos + _TexOffset ), normalWS, 1.0, temp_cast_0, 1.0, 0 );
				float lerpResult32 = lerp( 0.0 , normalWS.y , ( ase_worldPos.y + 0.2 ));
				float temp_output_25_0 = step( lerpResult32 , _TopThreshold );
				float4 lerpResult18 = lerp( float4( 0,0,0,0 ) , ( _Color * triplanar12 ) , temp_output_25_0);
				float4 temp_cast_2 = (1.0).xxxx;
				#ifdef _HASGRID_ON
				float4 staticSwitch47 = triplanar12;
				#else
				float4 staticSwitch47 = temp_cast_2;
				#endif
				float4 lerpResult29 = lerp( lerpResult18 , ( _TopColor * staticSwitch47 ) , ( 1.0 - temp_output_25_0 ));
				
				surfaceDescription.BaseColor = lerpResult29.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar12 = TriplanarSampling12( _Texture0, ( ase_worldPos + _TexOffset ), ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float lerpResult32 = lerp( 0.0 , ase_worldNormal.y , ( ase_worldPos.y + 0.2 ));
				float temp_output_25_0 = step( lerpResult32 , _TopThreshold );
				float4 lerpResult18 = lerp( float4( 0,0,0,0 ) , ( _Color * triplanar12 ) , temp_output_25_0);
				float4 temp_cast_2 = (1.0).xxxx;
				#ifdef _HASGRID_ON
...
WireConnection;12;9;54;0
WireConnection;12;3;57;0
WireConnection;54;0;53;0
WireConnection;54;1;55;0
ASEEND*/
//CHKSM=AD61004C9232F5136AC5F39C89182CDD26485875